...
/******/ 	return __webpack_require__(__webpack_require__.s = "./panel/monitor-factory/module.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./panel/monitor-factory/module.ts":
/*!*****************************************!*\
  !*** ./panel/monitor-factory/module.ts ***!
  \*****************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PanelCtrl", function() { return RmsMonitorFactoryPanelCtrl; });
/* harmony import */ var snapsvg_dist_snap_svg_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! snapsvg/dist/snap.svg-min.js */ "../node_modules/snapsvg/dist/snap.svg-min.js");
/* harmony import */ var snapsvg_dist_snap_svg_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(snapsvg_dist_snap_svg_min_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _services_remoteSolutionMQTT__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/remoteSolutionMQTT */ "./services/remoteSolutionMQTT.ts");
...
var RmsMonitorFactoryPanelCtrl = /** @class */ (function (_super) {
    ...
    function RmsMonitorFactoryPanelCtrl($scope, $injector, $element, $location, rsMqttSrv, rsDsSrv) {
        ...
        _this.svgImgPath = "public/plugins/proj-rms-plugin-app/img/rms-fatory-kr.svg";
        _this._svg = null;
    ...
    Object.defineProperty(RmsMonitorFactoryPanelCtrl.prototype, "container", {
        get: function () { return this._container; },
        set: function (container) { this._container = container; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RmsMonitorFactoryPanelCtrl.prototype, "svg", {
        get: function () { return this._svg; },
        set: function (svg) { this._svg = svg; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RmsMonitorFactoryPanelCtrl.prototype, "recvData", {
        get: function () { return this._recvData; },
    ...
    Object.defineProperty(RmsMonitorFactoryPanelCtrl.prototype, "animations", {
        get: function () { return this._animations; },
        set: function (animation) { this._animations = animation; },
        enumerable: true,
        configurable: true
    });
    RmsMonitorFactoryPanelCtrl.prototype.loadSVG = function (path) {
        return new Promise(function (resolve, reject) {
            snapsvg_dist_snap_svg_min_js__WEBPACK_IMPORTED_MODULE_0__["load"](path, resolve);
        });
    };
    RmsMonitorFactoryPanelCtrl.prototype.onInitialized = function () {
        var _this = this;
        ...
        this.loadSVG(this.svgImgPath).then(function (svg) {
            if (_this.svg === null) {
                ...
                _this.svg = snapsvg_dist_snap_svg_min_js__WEBPACK_IMPORTED_MODULE_0__(node_1.find("> svg")[0]);
    ...
    RmsMonitorFactoryPanelCtrl.prototype.getViewData = function (results) {
    ...
    RmsMonitorFactoryPanelCtrl.prototype.showData = function (viewData) {
        console.log(viewData);
    };
    RmsMonitorFactoryPanelCtrl.prototype.onDataReceived = function (results) {
        var canUseDs;
    ...
    RmsMonitorFactoryPanelCtrl.prototype.onInitEditMode = function () { };
    RmsMonitorFactoryPanelCtrl.prototype.link = function (scope, elem, attrs, ctrl) { };
    RmsMonitorFactoryPanelCtrl.template = __webpack_require__(/*! ./partial/template.html */ "./panel/monitor-factory/partial/template.html");
    return RmsMonitorFactoryPanelCtrl;
...
/***/ "./panel/monitor-factory/partial/template.html":
/*!*****************************************************!*\
  !*** ./panel/monitor-factory/partial/template.html ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "<div id=\"{{ctrl.divID}}\" class=\"thingspin-rms-monitor-factory\" width='100%'></div>";
