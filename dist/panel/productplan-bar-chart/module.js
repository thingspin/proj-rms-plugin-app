...
/******/ 	return __webpack_require__(__webpack_require__.s = "./panel/productplan-bar-chart/module.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./panel/productplan-bar-chart/module.ts":
/*!***********************************************!*\
  !*** ./panel/productplan-bar-chart/module.ts ***!
  \***********************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PanelCtrl", function() { return RmsProductPlanBarChartPanelCtrl; });
...
var RmsProductPlanBarChartPanelCtrl = /** @class */ (function (_super) {
    ...
    function RmsProductPlanBarChartPanelCtrl($scope, $injector) {
        ...
        _this.arrayTrueEmpty = new Array();
        _this.arrayFalseEmpty = new Array();
    ...
    RmsProductPlanBarChartPanelCtrl.prototype.createChart = function (inputData) {
        if (inputData !== undefined) {
            ...
            this.chart = new chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2__(this.context, chartOpts);
        }
            ...
            if (!this.chart) {
                this.chart = new chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2__(this.context, {
                    type: 'bar',
                    data: {
    ...
    RmsProductPlanBarChartPanelCtrl.prototype.removeData = function (chart) {
        chart.data.datasets.forEach(function (dataset) {
            dataset.data.pop();
        });
        chart.update();
...
/***/ "./panel/productplan-bar-chart/templet.html":
/*!**************************************************!*\
  !*** ./panel/productplan-bar-chart/templet.html ***!
  \**************************************************/
/*! no static exports found */
