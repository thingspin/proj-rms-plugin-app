...
/******/ 	return __webpack_require__(__webpack_require__.s = "./panel/productstate-bar-chart/module.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./panel/productstate-bar-chart/module.ts":
/*!************************************************!*\
  !*** ./panel/productstate-bar-chart/module.ts ***!
  \************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PanelCtrl", function() { return RmsProductStateBarChartPanelCtrl; });
...
/* harmony import */ var chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! chart.js/dist/Chart.min */ "../node_modules/chart.js/dist/Chart.min.js");
/* harmony import */ var chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2__);
...
var RmsProductStateBarChartPanelCtrl = /** @class */ (function (_super) {
    ...
    function RmsProductStateBarChartPanelCtrl($scope, $injector) {
        ...
        _this.COLOR = ['#4dc9f6', '#f67019', '#f53794', '#537bc4', '#acc236', '#166a8f', '#00a950', '#58595b', '#8549ba'];
    ...
    RmsProductStateBarChartPanelCtrl.prototype.onInitialized = function () {
    ...
    RmsProductStateBarChartPanelCtrl.prototype.createChart = function (inputData) {
        if (inputData) {
            ...
            this.chart = new chart_js_dist_Chart_min__WEBPACK_IMPORTED_MODULE_2__(this.context, charOpts);
        }
        else {
            if (this.chart) {
                this.chart.clear();
    ...
    RmsProductStateBarChartPanelCtrl.prototype.removeData = function (chart) {
        chart.data.datasets.forEach(function (dataset) {
            dataset.data.pop();
        });
        chart.update();
    ...
    RmsProductStateBarChartPanelCtrl.prototype.render = function () {
        // console.log("render");
        if (!this.context) {
            return;
        }
...
/***/ "./panel/productstate-bar-chart/templet.html":
/*!***************************************************!*\
  !*** ./panel/productstate-bar-chart/templet.html ***!
  \***************************************************/
/*! no static exports found */
