...
/******/ 	return __webpack_require__(__webpack_require__.s = "./panel/inspection-property/module.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./panel/inspection-property/module.ts":
/*!*********************************************!*\
  !*** ./panel/inspection-property/module.ts ***!
  \*********************************************/
/*! exports provided: InspectionPropertyPanelCtrl, PanelCtrl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InspectionPropertyPanelCtrl", function() { return InspectionPropertyPanelCtrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PanelCtrl", function() { return InspectionPropertyPanelCtrl; });
...
var InspectionPropertyPanelCtrl = /** @class */ (function (_super) {
    __extends(InspectionPropertyPanelCtrl, _super);
    function InspectionPropertyPanelCtrl($scope, $injector, $rootScope, alertSrv, rsDsSrv, rsMqttSrv) {
    ...
    InspectionPropertyPanelCtrl.prototype.onInitialized = function () {
    };
    InspectionPropertyPanelCtrl.prototype.onInitEditMode = function () {
    };
    InspectionPropertyPanelCtrl.prototype.onRender = function () {
    };
    InspectionPropertyPanelCtrl.prototype.onDataReceived = function (dataList) {
        var _this = this;
        var data = this.rsDsSrv.getTableObj(dataList);
        dataList.forEach(function (result, idx) {
            if (result.meta.sql.includes("IP_TYPE=1")) {
                _this.inspectList = data[idx];
            }
            else if (result.meta.sql.includes("IP_TYPE=2")) {
                _this.faultyList = data[idx];
            }
        });
    ...
    */
    InspectionPropertyPanelCtrl.prototype.getInspectionProperty = function (name) {
    ...
    InspectionPropertyPanelCtrl.prototype.addInspectionItem = function (ipType, name, desc, min, max, cpk_min, cpk_max) {
        var _this = this;
        var selectId = this.datasource.id;
        var columns = "( NAME";
        var values = "('" + name + "'";
    ...
    InspectionPropertyPanelCtrl.prototype.deleteInspectionItem = function () {
        var _this = this;
    ...
    InspectionPropertyPanelCtrl.prototype.updateInspectionItem = function () {
        var _this = this;
        var selectId = this.datasource.id;
    ...
    InspectionPropertyPanelCtrl.prototype.setMode = function (mode) {
        this.mode = mode;
        // this.updateInspectionPropertyList(selectId);
        this.refresh();
    };
    ...
    InspectionPropertyPanelCtrl.template = __webpack_require__(/*! ./view.html */ "./panel/inspection-property/view.html");
    return InspectionPropertyPanelCtrl;
...
/***/ "./panel/inspection-property/view.html":
/*!*********************************************!*\
  !*** ./panel/inspection-property/view.html ***!
  \*********************************************/
/*! no static exports found */
